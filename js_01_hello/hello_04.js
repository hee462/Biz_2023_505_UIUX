...
위치가 재 배치 될수 있다
아래의 코드에서 num1 변수가 선언되기 전에 num1 변수값을 console.log()로 출력하면
...
if(){} 블럭 내부에 선언된 num2 변수는 이름은 같지만 일반적인 프로그래밍
언어에서는 전혀 다른 변수로 취급된다
따라서 if(){} 내에서 num2 변수에 저장된 값은
if(){}이 종료되면 사라지고
if(){} 이후에 num2 변수의 값은 200 이 되어야 한다
JS 에서 var 키워드로 선언된 변수는 그렇지 못한다
scope issue 라고 하며 매우 중요한 이슈이므로 잘 살펴야한다
*/
var num2 = 200;
if (num1 % 2 == 0) {
  var num2 = "대한민국";
...
JS 의 권장 문법에서는 JS함수 밖에서 선언된 변수를 함수내부에서 변경하지 말도록한다
